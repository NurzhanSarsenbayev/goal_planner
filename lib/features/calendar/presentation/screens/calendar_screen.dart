            ...
            if (selectedDateTasks.isEmpty)
              ...
              for (final task in selectedDateTasks) ...[
                TaskCard(
                  ...
                  onDeleteRecurringSeries: task.recurringRuleId == null
                      ? null
                      : () {
                          widget.onDeleteRecurringTaskRule(
                            task.recurringRuleId!,
                          );
                        },
                  onConvertToRecurring: task.recurringRuleId == null
                      ? () {
                          widget.onConvertTaskToRecurring(task);
                        }
                      : null,
                  onScheduleDate: () {
